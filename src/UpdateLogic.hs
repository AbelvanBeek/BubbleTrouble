...
handleBallCollisions (Level p1 p1o p2 p2o enemies lvl ani pics) 
      = (Level (updateScore p1score p1) (filterindices p1arrowindices p1o) (updateScore p2score p2) (filterindices p2arrowindices p2o) ((concat (map splitb hitballs)) ++ (filterindices balls enemies)) lvl (ani ++ createExplosions hitballs) pics)
...
checkGameOver (Level (Player (P1 (PlayerInfo _ _ _ p1life))) p1o (Player (P2 (PlayerInfo _ _ _ p2life))) _ _ _ _ _) 
